...
const ViewAdmins: React.FC<Props> = ({ userRole , userData }) => {
...
export const getServerSideProps = async () => {
  ...
  try {
    ...
    const userAdmin = await User.find({ role: process.env.auth });
    ...
    return {
      props: {
        userRole,
        userData: JSON.parse(JSON.stringify(userAdmin)), // Parse JSON string to array of objects
      },
    };
  } catch (error) {
